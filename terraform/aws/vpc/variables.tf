...
variable "deploy_subnet_suffix" {
  description = "Suffix to append to deploy subnets name"
  type        = string
  default     = "deploy"
}
...
variable "deploy_subnets" {
  description = "A list of deploy subnets"
  type        = list(string)
  default     = []
}
...
variable "create_deploy_internet_gateway_route" {
  type        = bool
  default     = false
}

variable "create_deploy_nat_gateway_route" {
  type        = bool
  default     = false
}

variable "create_bastion_internet_gateway_route" {
  type        = bool
  default     = false
}

variable "create_bastion_nat_gateway_route" {
  type        = bool
  default     = false
}
...
variable "deploy_route_table_tags" {
  description = "Additional tags for the deploy route tables"
  type        = map(string)
  default     = {}
}

variable "bastion_route_table_tags" {
  type        = map(string)
  default     = {}
}
...
variable "deploy_subnet_tags" {
  description = "Additional tags for the deploy subnets"
  type        = map(string)
  default     = {}
}

variable "bastion_subnet_tags" {
  type        = map(string)
  default     = {}
}
...
variable "deploy_acl_tags" {
  description = "Additional tags for the deploy subnets network ACL"
  type        = map(string)
  default     = {}
}

variable "bastion_acl_tags" {
  type        = map(string)
  default     = {}
}
...
variable "deploy_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for deploy subnets"
  type        = bool
  default     = false
}

variable "bastion_dedicated_network_acl" {
  type        = bool
  default     = false
}
...
variable "deploy_inbound_acl_rules" {
  description = "deploy subnets inbound network ACLs"
  type        = list(map(string))
...
variable "deploy_outbound_acl_rules" {
  description = "deploy subnets outbound network ACLs"
  type        = list(map(string))
...
variable "bastion_inbound_acl_rules" {
  type        = list(map(string))
...
variable "bastion_outbound_acl_rules" {
  type        = list(map(string))
